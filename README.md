...
🧠 About Me
I'm a Computer Vision & Machine Learning Developer working as a Software Engineer Intern at A3 Services, focused on building real-time vision systems and agentic AI pipelines.

🔭 Currently building: AI Agent (Sugarcane) — a RAG-powered agent for domain-specific Q&A
...
🏗️ How I Build
Data → Preprocessing (OpenCV/MediaPipe) → Model (PyTorch/YOLO) → Evaluation → Deployment (Docker) → Monitoring
For RAG systems: Documents → Embeddings (FAISS) → Retriever → LLM → Agent Response
...
Smart Home Security — Real-time home security using CV & detection models — OpenCV, YOLO
Restaurant Recommendation System — ML-based recommendation engine — Python, ML
Automatic Attendance — Face-recognition based attendance system — OpenCV, MediaPipe
Bank ATM — Python-based simulation project — Python
AI-Enhanced Intrusion Detection — Jupyter Notebook based intrusion detection with AI — Python, ML
...
🐍 Contribution Snake
<p align="center">
<img src="https://raw.githubusercontent.com/parshav42/parshav42/output/github-contribution-grid-snake.svg" alt="snake animation" />
</p>
